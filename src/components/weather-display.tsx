...
export const WeatherDisplay = ({ onClose, ...props }: WeatherDisplayProps) => {
  return (
    <>
      <CardContent className="animate-fade-in flex h-full flex-col p-0 opacity-0 [transform:rotateY(180deg)]">
        {/** close button */}
        ...
        <div className="flex h-1/3 w-full  items-center justify-between bg-black/40 p-4">
          <div>
            <p className="text-lg font-semibold">{props.weather.name}</p>
